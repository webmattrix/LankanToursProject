                                                    ...
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <label for="adminProfilePicture" id="adminProfileViewImage" class="admin-profile-picture d-flex justify-content-center align-items-center" style="<?php
                                                                                                                                                                                                            if (empty($employee_data["profile_picture"])) {
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                echo ("background-image: url('../assets/img/profile/admin/" . $employee_data["profile_picture"] . "');");
                                                                                                                                                                                                            }
                                                                                                                                                                                                            ?>">
                                                            <iconify-icon icon="ph:camera-fill"></iconify-icon>
                                                        </label>
                                                        <input type="file" id="adminProfilePicture" class="d-none" onchange="changeAdminImageUploader();" />
                                                    </div>
                                                    <div class="d-flex mt-4 flex-column">
                                                        <span class="">Name</span>
                                                        <input type="text" class="form-control" id="adminName" value="<?php echo ($employee_data["emp_name"]); ?>">
                                                    </div>
                                                    <div class="d-flex mt-4 flex-column">
                                                        <span class="">Mobile</span>
                                                        <input type="text" class="form-control" id="adminMobile" value="<?php echo ($employee_data["mobile"]); ?>">
                                                    </div>
                                                    <div class="d-flex mt-4 flex-column">
                                                        <span class="">Address</span>
                                                        <input type="text" class="form-control" id="adminAddress" value="<?php echo ($employee_data["address"]); ?>">
                                                    </div>
                                                    <div class="d-flex mt-5 flex-column">
                                                        <div class="d-flex mt-3 flex-column">
                                                            <span>Email</span>
                                                            <input type="text" class="form-control" id="adminEmail" disabled="true" value="<?php echo ($employee_data["email"]); ?>">
                                                        </div>
                                                        <div class="d-flex mt-3 flex-column">
                                                            <span>Password</span>
                                                            <div class="position-relative">
                                                                <input type="password" id="adminPassword" placeholder="********" class="form-control pe-5">
                                        ...
                                        <div class="position-fixed top-0 start-0 vh-100 vw-100 bg-dark bg-opacity-50 d-flex justify-content-center align-items-center d-none" id="profileOtpModel">
                                            <div class="bg-white rounded overflow-hidden" style="height: fit-content; width: 500px; max-width: 80vw;">
                                                ...
                                                <div class="px-2 pb-3 pt-5 d-flex flex-column gap-2">
                                                    ...
                                                    <button class="btn px-4 text-white col-6 offset-3" style="background-color: #0F6884;" onclick="changeAdminProfile();">Verify</button>
                                                </div>
