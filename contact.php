                        ...
                        <div class="col">
                            <div class="col-12  p-4 contactCard ">
                                <div class="row" style="z-index: 100;">
                                    <div class="col-2 ">
                                        <img src="./assets/img/ContactPage_IMG/photo-1494790108377-be9c29b29330.jpg"
                                ...
                                <div class="col-12" style="font-family: 'QuickSand';">
                                    <h6 class="text-lg-start mt-3"> <i class="bi bi-envelope-fill"></i> &nbsp;
                                        &nbsp;EmailAddress@gmail.com</h6>
                                    <h6 class="text-lg-start"><i class="bi bi-telephone-inbound-fill"></i>&nbsp;&nbsp;+94
                                        765347479</h6>
