                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-12">
                                                ...
                                                <h6 class="text-lg-end" style="font-family:QuickSand;"><i class="bi bi-star-fill  text-warning"></i>&nbsp;&nbsp;
                                                    <?php echo $guide_data02["rating"] ?>/5
                                                </h6>
                                                <h6 class="text-lg-end" style="font-family:QuickSand;"><i class="bi bi-telephone-inbound-fill"></i>&nbsp;&nbsp;
