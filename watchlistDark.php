                    ...
                    <div class="col-12">
                        <div class="row">
                            <div class="col-12 mt-3 mb-lg-4">
                                <div class="col-12" style="background-color: #3E3E3E; border-radius: 5px; height: 73vh; overflow-y: auto; overflow-x: hidden;">
                                    <div class="row p-lg-4" style="row-gap: 0.3in;">
                                        <div class="col-12">
                                            <div class="col-12 py-3" style="border-radius: 6px; border: 1px solid #7B7B7B; box-shadow: 1px 2px 4px 0px rgba(0, 0, 0, 0.50);">
                                                <div class="row">
                                                    <div class="col-5">
                                                    ...
                                                    <div class="col-7 my-2" style="border-left: 2px solid #7B7B7B;">
                                                        <div class="row">
                                                            <span style="font-family: 'Quicksand'; font-size: calc(0.61rem + 0.61vh); font-weight: 700; color: #fff;">11 Day Tour Plan</span>
                                                            <div class="col-12">
                                                                <div class="row ms-lg-3 mt-2">
                                                                    <div class="col-7 m-0 p-0">
                                                                        <p style="font-family: 'Quicksand'; font-size: calc(0.51rem + 0.51vh); font-weight: 400; color: #fff;">Lorem ipsum dolor sit amet consectetur. Praesent placerat ullamcorper enim tincidunt tempus nulla consequat dolor in. Tortor eu vestibulum tortor facilisi commodo. Magna euismod leo ullamcorper id aliquam.</p>
                                                                    </div>
                                                                    <div class="col-12">
                                                                        <div class="row">
                                                                            <div class="col-4">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="row mt-lg-5">
                                                                    <div class="col-8">
                                                                        <span style="font-family: 'Quicksand'; font-size: calc(0.57rem + 0.57vh); font-weight: 600; color: #fff;">Visiting Places</span>
                                                                        <div class="col-12">
                                                                            <div class="row">
                                                                                <div class="col-6">
                                                                                    <div class="row justify-content-center gap-3 mt-2">
                                                                                        <div class="col-3 includeBlog1">
                                                                                            <span class="placesText2">Galle</span>
                                                                                        </div>
                                                                                        <div class="col-3 includeBlog1">
                                                                                            <span class="placesText2">Colombo</span>
                                                                                        </div>
                                                                                        <div class="col-3 includeBlog1">
                                                                                            <span class="placesText2">Ella</span>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="row justify-content-center gap-3 mt-2">
                                                                                        <div class="col-3 includeBlog1">
                                                                                            <span class="placesText2">Kandy</span>
                                                                                        </div>
                                                                                        <div class="col-3 includeBlog1">
                                                                                            <span class="placesText2">Mirissa</span>
                                                                                        </div>
                                                                                        <div class="col-3 includeBlog1">
                                                                                            <span class="placesText2">Anuradhapura</span>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="col-12 py-3" style="border-radius: 6px; border: 1px solid #7B7B7B; box-shadow: 1px 2px 4px 0px rgba(0, 0, 0, 0.50);">
                                                <div class="row">
                                                    ...
                                                    <div class="col-7 my-2" style="border-left: 2px solid #7B7B7B;">
                                                        <div class="row">
                                                            <span style="font-family: 'Quicksand'; font-size: calc(0.61rem + 0.61vh); font-weight: 700; color: #fff;">7 Day Luxury Tour Plan</span>
                                                            <div class="col-12">
                                                                <div class="row ms-lg-3 mt-2">
                                                                    <div class="col-7 m-0 p-0">
                                                                        <p style="font-family: 'Quicksand'; font-size: calc(0.51rem + 0.51vh); font-weight: 400; color: #fff;">Lorem ipsum dolor sit amet consectetur. Praesent placerat ullamcorper enim tincidunt tempus nulla consequat dolor in. Tortor eu vestibulum tortor facilisi commodo. Magna euismod leo ullamcorper id aliquam.</p>
